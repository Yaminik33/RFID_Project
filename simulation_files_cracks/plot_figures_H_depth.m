...
%%
close all;
h_depth= load('horizontal_depth.mat');
hd= h_depth.hd;
...
% subplot 221
hold on
plot(hd(:,1),hd(:,2),'r','DisplayName', '1mm', 'LineWidth', 2.0)
plot(hd(:,1),hd(:,3),'k--','DisplayName', '2mm', 'LineWidth', 2.0) 
plot(hd(:,1),hd(:,4),'r--', 'DisplayName', '3mm', 'LineWidth',2.0)
plot(hd(:,1),hd(:,5),'k','DisplayName', '4mm', 'LineWidth', 2.0)
plot(hd(:,1),hd(:,6),'r:','DisplayName', '5mm', 'LineWidth', 2.0); 
...
% Save as a high-resolution TIFF
 print('hd1', '-depsc', '-r300'); % Change resolution as needed
...
% Save as a high-resolution TIFF
 print('hd2', '-depsc', '-r300'); % Change resolution as needed
