...
%%
close all;
v_depth= load('vertical_depth.mat');
vd= v_depth.vd;
...
% subplot 221
hold on
plot(vd(:,1),vd(:,2),'r','DisplayName', '1mm', 'LineWidth', 2.0)
plot(vd(:,1),vd(:,3),'k--','DisplayName', '2mm', 'LineWidth', 2.0) 
plot(vd(:,1),vd(:,4),'r--', 'DisplayName', '3mm', 'LineWidth',2.0)
plot(vd(:,1),vd(:,5),'k','DisplayName', '4mm', 'LineWidth', 2.0)
plot(vd(:,1),vd(:,6),'r:','DisplayName', '5mm', 'LineWidth', 2.0); 
...
% Save as a high-resolution TIFF
 print('vd1', '-depsc', '-r300'); % Change resolution as needed
...
% Save as a high-resolution TIFF
 print('vd2', '-depsc', '-r300'); % Change resolution as needed
