...
%%
close all;
h_width= load('horizontal_width.mat');
hw= h_width.hw;
...
% subplot 221
hold on
plot(hw(:,1),hw(:,2),'r','DisplayName', '1mm', 'LineWidth', 2.0)
plot(hw(:,1),hw(:,3),'k--','DisplayName', '2mm', 'LineWidth', 2.0) 
plot(hw(:,1),hw(:,4),'r--', 'DisplayName', '3mm', 'LineWidth',2.0)
plot(hw(:,1),hw(:,5),'k','DisplayName', '4mm', 'LineWidth', 2.0)
plot(hw(:,1),hw(:,6),'r:','DisplayName', '5mm', 'LineWidth', 2.0); 
...
print('hw1', '-depsc', '-r300'); % Change resolution as needed
...
% Save as a high-resolution TIFF
print('hw2', '-depsc', '-r300'); % Change resolution as needed
